...
\begin{description}[style=multiline,nosep,itemsep=3ex,itemindent=0.5cm]
	...
	\begin{itemize}[leftmargin=4em, align=left]
		\item[uforandret] \eo{dek{\textbar}kelk{\textbar}e} \eo{post \T da sekundoj}

		\item[med tilf{\o}jelse af endelse] \eo{danc{\textbar}ad{\textbar}o}\ \eo{lerni\T{}n} (dancadon)
		
		\item[med udskiftning af endelse] \eo{danc{\textbar}i\ \ }\ \ \eo{La kuloj \T{}as} (dancas)
		
		\item[i et sammensat ord] \eo{baskul{\textbar}o}\ \ \eo{\T{}ponto} (baskulponto/baskuloponto)
