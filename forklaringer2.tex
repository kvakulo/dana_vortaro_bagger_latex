...
fx
\\[6pt]
\hspace*{0.7cm}\eo{an\^co}~~blad, tunge, (i bl{\ae}seinstrument)
\\[8pt]
Hvis der ikke
er komma foran parentesen, g{\ae}lder den kun det ord eller udtryk der
st{\aa}r lige foran parentesen, fx
\\[6pt]
\hspace*{0.7cm}\eo{ajn}~~som helst, ligegyldigt (hvem, hvilken)
\\[8pt]
...
Verberne markeres i ordbogen kun med \textstylevkategori{tr} eller \textstylevkategori{itr},
